...
<main id="mainReg">
    ...
    <section id="allFormCont">
        ...
        <form id="registerForm" action="registerProcessing.php" onsubmit="return register();" method="post">
            ...
            <ul class="errCont" id="emailList"><?php if($emailErr !== null){echo $emailErr;}?>
            </ul>
            <label for="phoneNvm">
                <h3>Phone Number:</h3>
            </label>
            <input type="text" id="rPhoneNvm" name="rPhoneNvm">
            <ul class="errCont" id="phoneNvmList"><?php if($phoneErr !== null){echo $phoneErr;}?>
            </ul>
            <label for="psw">
                <h3>Password:</h3>
            </label>
            <input type="password" id="psw" name="psw">
            <ul class="errCont" id="pwList"><?php if($pswErr !== null){echo $pswErr;}?></ul>
            <label for="pswCheck">
                <h3>Retype password:</h3>
            </label>
            <input type="password" id="pswCheck" name="pswCheck">
            <ul class="errCont" id="repwList"><?php if($repswErr !== null){echo $repswErr;}?></ul>
            <label for="pic">
            ...
            <ul class="errCont" id="fNameList"><?php if($fNameErr !== null){echo $fNameErr;}?>
            </ul>
            <label for="lName">
                <h3>Last Name:</h3>
            </label>
            <input type="text" id="lName" name="lName">
            <ul class="errCont" id="lNameList"><?php if($lNameErr !== null){echo $lNameErr;}?>
            </ul>
            <label for="address">
                <h3>Address:</h3>
            </label>
            <input type="text" id="address" name="address">
            <ul class="errCont" id="addressList">
                <?php if($addressErr !== null){echo $addressErr;}?></ul>
            <label for="city">
                <h3>City:</h3>
            </label>
            <input type="text" id="city" name="city">
            <ul class="errCont" id="cityList"><?php if($cityErr !== null){echo $cityErr;}?></ul>
            <label for="zCode">
                <h3>Zipcode:</h3>
            </label>
            <input type="text" id="zCode" name="zCode" placeholder="only 4 ~ 6 digits are available">
            <ul class="errCont" id="zCodeList"><?php if($zCodeErr !== null){echo $zCodeErr;}?>
            </ul>
...
<?php
    ...
    $jsArr = ["cookies","register","formvalidation","checkstatus"];
    callJSfile($jsArr);       
?>